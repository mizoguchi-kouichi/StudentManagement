...
public class StudentController {
     ...
     */
    @PatchMapping("/students/grade/{grade}:batchUpdate")
    public ResponseEntity<StudentResponse> updateGrade(@PathVariable("grade") String grade) {
        studentService.updateGrade(grade);
